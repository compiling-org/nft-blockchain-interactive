...
- Source module: `src/rust-client/`
- Extracted repo: `C:/Users/kapil/compiling/grant-repositories/rust-foundation-audiovisual`
- Real AI: TensorFlow.js inference integrated on frontend demos; Rust WASM bindings active
- WebGPU: migration planned; current engine uses WebGL pathways in `webgpu_engine.rs`
