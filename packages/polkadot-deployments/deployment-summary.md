...
## Westend Network Info
- **RPC Endpoint**: wss://westend-rpc.polkadot.io
- **Faucet**: https://faucet.polkadot.io/westend
- **Explorer**: https://westend.subscan.io/
- **Notes**:
  - Faucet grants `100 WND` per request, once every `24h`
  - You can target a specific parachain via `Use custom chain id` or `?parachain=<ID>`
  - Verify balances in Polkadot{.js} Apps after switching network to `Westend`
