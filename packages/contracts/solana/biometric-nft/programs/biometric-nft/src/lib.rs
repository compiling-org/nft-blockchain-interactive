...
pub mod biometric_nft {
    ...
    pub fn initialize(ctx: Context<Initialize>) -> Result<()> {
        ...
        nft_account.ai_model_version = String::new();
    ...
    pub fn mint_biometric_nft(
        ...
        nft_account.ai_model_version = ai_model_version.clone();
        ...
        msg!("AI Model Version: {}", ai_model_version);
    ...
    pub fn update_cross_chain_id(
        ctx: Context<UpdateCrossChainId>,
        new_cross_chain_id: String,
    ) -> Result<()> {
        let nft_account = &mut ctx.accounts.nft_account;
        ...
        nft_account.cross_chain_id = new_cross_chain_id.clone();
        nft_account.last_update_timestamp = Clock::get()?.unix_timestamp;

        msg!("Cross-chain ID updated for NFT {}: {}", nft_account.token_id, new_cross_chain_id);
...
#[derive(Accounts)]
pub struct UpdateCrossChainId<'info> {
    #[account(mut)]
    pub nft_account: Account<'info, BiometricNFT>,
    pub user: Signer<'info>,
}
