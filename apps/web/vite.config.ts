...
export default defineConfig({
  ...
  resolve: {
    alias: [
      { find: /^rpc-websockets$/, replacement: resolve(__dirname, './node_modules/rpc-websockets/dist/index.browser.js') },
      { find: 'rpc-websockets/dist/lib/client', replacement: resolve(__dirname, './node_modules/rpc-websockets/dist/lib/client') },
      { find: '@rust-client', replacement: resolve(__dirname, '../../packages/rust-client/pkg') },
      { find: '@rust-foundation-audiovisual', replacement: resolve(__dirname, '../../packages/rust-foundation-audiovisual/pkg') },
