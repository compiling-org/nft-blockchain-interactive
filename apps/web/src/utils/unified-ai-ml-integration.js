...
import { sha256AsHex } from '@polkadot/util-crypto';
 ...
 */
import * as nftRustClient from '@rust-client';
import * as rustFoundationAudiovisual from '@rust-foundation-audiovisual';
const voiceIntegration = nftRustClient; // Mocked/Re-routed
const leapMotionIntegration = nftRustClient; // Mocked/Re-routed

export class WASMMLBridge {
  constructor() {
    this.nftRustClient = null;
    this.rustFoundationAudiovisual = null;
    this.voiceIntegration = null;
    this.leapMotionIntegration = null;
  ...
  async initialize() {
    ...
    try {
      ...
      // WASM modules are already initialized when imported
      // No need to call .default() - they're ready to use
      this.nftRustClient = nftRustClient;
      this.rustFoundationAudiovisual = rustFoundationAudiovisual;
      this.voiceIntegration = voiceIntegration;
      this.leapMotionIntegration = leapMotionIntegration;
      ...
      console.warn('⚠️ Continuing without WASM modules');
      this.initialized = true;
    }
  }
