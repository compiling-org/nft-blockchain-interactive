...
import { CrossChainBridge as BridgeClass } from '../utils/cross-chain-bridge';
import { bridgeConfig } from '../config/cross-chain-bridge-config';
...
const CrossChainBridge: React.FC<CrossChainBridgeProps> = ({ className = '' }) => {
  ...
  const initializeBridge = async () => {
    ...
    try {
      const bridgeInstance = new BridgeClass(bridgeConfig);
      const initSuccess = await bridgeInstance.initializeSolana(); // Simplified for now
