...
cp -r ../blockchain-nft-interactive/src/marketplace ../grant-repositories/mintbase-creative-marketplace/src/
echo "📦 Copied marketplace components"

# Copy Rust client (core dependency)
cp -r ../blockchain-nft-interactive/src/rust-client ../grant-repositories/mintbase-creative-marketplace/src/
...
# Create a simplified test website with only Mintbase components
cat > ../grant-repositories/mintbase-creative-marketplace/test-website/index.html << 'EOF'
<!DOCTYPE html>
<html>
<head>
    <title>Mintbase Creative Marketplace</title>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        <div class="header">
            <h1>🛒 Mintbase Creative Marketplace</h1>
            <p>DAO-governed marketplace for emotionally-responsive digital art</p>
        </div>
...
# Copy build scripts
cp ../blockchain-nft-interactive/build-mintbase-grant.sh ../grant-repositories/mintbase-creative-marketplace/
cp ../blockchain-nft-interactive/install-cli-tools.sh ../grant-repositories/mintbase-creative-marketplace/scripts/
